...
4. **Supply, upkeep and decay** (agreed 2026-09-25, see DESIGN "Supply and upkeep"): A supply network and build rules (done), B the ship's 24-slot inventory, upkeep drain and decay, C the hub (mockups first).
