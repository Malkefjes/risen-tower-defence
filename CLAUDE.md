...
- **Next:** Erik picks a ship from `mockups/ship/` (3×3 footprint; published at https://claude.ai/artifact/NPGkLrVg6Pa4hjFpzexyk7), then M1a. Work one step at a time: describe exactly what you'll build next and wait for Erik's feedback before implementing.
