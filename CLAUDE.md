...
- **Ore look:** mockup `mockups/ore/` (https://claude.ai/artifact/PwXfZjDr7kB2rQexNtggfs): three deposit styles set into the ground (A cracked plate with veins, B crater, C tilted strata), each 2×2 and 3×3, gold ore. Waiting on Erik's pick.
