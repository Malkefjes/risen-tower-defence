...
- **Next:** Erik picks an avatar. First round (`mockups/avatar/`, https://claude.ai/artifact/H5ECqtwJGetKCkiSGX224s) didn't land; Exo-rig was the right direction. Exo-rig round (`mockups/exorig/`) also missed; Erik wants a humanoid exo-rig with plain labels, no themed names. Humanoid round (`mockups/humanoid/`): B was closest. B variations: `mockups/humanoid-b/` (https://claude.ai/artifact/Wayu8x6tCrr34gXH1oj7Gq). Then M1a part 1 (avatar + Rocket in the game), described to Erik before building.
