...
- **Next:** Erik picks an avatar. First round (`mockups/avatar/`, https://claude.ai/artifact/H5ECqtwJGetKCkiSGX224s) didn't land; Exo-rig was the right direction. Exo-rig round: `mockups/exorig/` (https://claude.ai/artifact/Kg91gc274sWpqi5yxubuGZ). Then M1a part 1 (avatar + Rocket in the game), described to Erik before building.
