...
- **Ship:** the Rocket (`mockups/rocketship/`, https://claude.ai/artifact/GBVZ8RpZPQaqY44reLU2hg): 3×3, four grid-aligned fins, Reactor core in an open cage mid-body, cargo door that is the ramp (shut when landing, opens after touchdown), fabricator hatch above it. Waiting on Erik's final OK.
