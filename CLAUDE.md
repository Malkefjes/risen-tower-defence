...
- **Next:** Erik picks an avatar. First round (`mockups/avatar/`, https://claude.ai/artifact/H5ECqtwJGetKCkiSGX224s) didn't land; Exo-rig was the right direction. Exo-rig round (`mockups/exorig/`) also missed; Erik wants a humanoid exo-rig with plain labels, no themed names. Humanoid round: `mockups/humanoid/` (https://claude.ai/artifact/PSRkCjNqyi57UCKtxP42bp). Then M1a part 1 (avatar + Rocket in the game), described to Erik before building.
