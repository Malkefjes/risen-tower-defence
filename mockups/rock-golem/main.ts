...
import refUrl from "./ref.jpg";
import "./style.css";

(document.getElementById("refImg") as HTMLImageElement).src = refUrl;

// Erik's rock golem rebuilt low poly, three ways, A/B/C, built the way the game would
...
const orcs: Mech[] = [];
const designs = [
  golem("Your colours", "#3d352f", "#2c2622", "#a08c74", "#8d7a63", "#5d6069", "#7fa8ff", 100),
  golem("Frost", "#434857", "#30343f", "#f2f4fa", "#d3d9e6", "#7fbfdd", "#8fd8ff", 200),
  golem("Violet vein", "#3a3640", "#29262e", "#9b74d6", "#7d58ba", "#5b5866", "#d7b8ff", 300),
];
